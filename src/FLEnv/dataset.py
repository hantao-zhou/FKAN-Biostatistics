...
def prepare_dataset(num_partitions: int, batch_size: int, train_ratio: float = 0.9):
    ...
    #basic transform
    tr = Compose([ToTensor(), Normalize((0, ), (1, )), Resize((480, 480))])
    ...
    for i in range(num_partitions):
        ...
        client_dataloaders.append([DataLoader(dataset_train, batch_size=batch_size, shuffle=False, sampler=train_sampler), DataLoader(dataset_valid, batch_size=batch_size, num_workers=2)])
